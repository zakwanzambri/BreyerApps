...
// CORS headers for frontend integration (only for API requests)
if (isset($_SERVER['REQUEST_METHOD']) && (strpos($_SERVER['REQUEST_URI'], '/api/') !== false || strpos($_SERVER['SCRIPT_NAME'], 'api') !== false)) {
